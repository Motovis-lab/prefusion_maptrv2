...
from prefusion.registry import MMENGINE_TASK_UTILS

__all__ = ["AlignedAnchor3DRangeGenerator", "AlignedAnchor3DRangeGeneratorPerCls"]


@MMENGINE_TASK_UTILS.register_module()
