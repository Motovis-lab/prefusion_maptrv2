...
class FreeAnchor3DHead(Anchor3DHead):
    ...
    def loss(self,
        ...
        Args:
            ...
            num_imgs int: number of images in a batch
        ...
        anchor_list = self.get_anchors(featmap_sizes, num_imgs)
        ...
        for _, (anchors_, gt_labels_, gt_bboxes_, cls_prob_, bbox_preds_,
            ...
            if len(gt_bboxes_) == 0:
                positive_losses.append(0.0 * bbox_preds.sum().reshape(1))
                continue
    ...
    def positive_bag_loss(self, matched_cls_prob, matched_box_prob):
        ...
        _device = bag_prob.device
        bag_prob = bag_prob.cpu()
        try:
            loss = F.binary_cross_entropy(bag_prob, torch.ones_like(bag_prob), reduction='none').to(_device)
        except RuntimeError:
            print(bag_prob)
            return 0.0 * bag_prob.sum()
    ...
    def negative_bag_loss(self, cls_prob, box_prob):
        ...
        return (1 - self.alpha) * negative_bag_loss.to(_device)
