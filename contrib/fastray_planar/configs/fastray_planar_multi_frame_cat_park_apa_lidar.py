...
transformables = dict(
    camera_images=dict(
        type='CameraImageSet',
        loader=dict(type='CameraTimeImageSetLoader',
                    camera_mapping=fisheye_camera_mapping),
...
train_dataset = dict(
    ...
    info_path='/ssd1/data/4d/mv_4d_infos_20231027_185823_lidar.pkl',
    model_feeder=dict(
...
model = dict(
    type='ParkingFastRayPlanarMultiFrameModelAPALidar',
    backbone=backbone,
