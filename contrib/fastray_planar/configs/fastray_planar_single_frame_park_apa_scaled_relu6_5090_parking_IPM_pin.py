...
heads = dict(
    ...
    polyline_3d=dict(type='PlanarHeadSimple',
                     ...
                     reg_channels=7 + 7,
                     relu6=relu6),
    parkingslot_3d=dict(type='ParkingSlotHead',
                        in_channels=128,
                        mid_channels=64,
                        cen_seg_channels=5,
                        reg_channels=15,
...
work_dir = "./work_dirs/fastray_planar_single_frame_park_apa_1110"
# load_from = "./work_dirs/fastray_planar_single_frame_park_apa_0820/20250821_000400/epoch_5.pth"
load_from = "./work_dirs/pretrained/epoch_8.pth"
# load_from = "./work_dirs/fastray_planar_single_frame_park_apa_0724_1/20250725_144717/epoch_16.pth"
