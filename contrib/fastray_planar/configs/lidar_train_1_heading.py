...
mapping_no_heading_objects = dict(
    ...
    class_mapping={
        ...
        'water_filled_barrier': [
            'class.traffic_facility.soft_barrier::attr.traffic_facility.soft_barrier.type.water_filled_barrier'],
        'cement_pier': [
            'class.traffic_facility.hard_barrier::attr.traffic_facility.hard_barrier.type.cement_isolation_pier'],
...
mapping_cylinder_objects = dict(
    ...
    class_mapping={
        ...
        'roadblock': [
            'class.traffic_facility.hard_barrier::attr.traffic_facility.hard_barrier.type.retractable_roadblock'],
        ...
        'warning_triangle': [
            'class.traffic_facility.soft_barrier::attr.traffic_facility.soft_barrier.type.warning_triangle'],
...
virtual_camera_settings = dict(
    VCAMERA_FISHEYE_FRONT=dict(cam_type='FisheyeCamera', resolution=fisheye_resolution, euler_angles=[-120, 0, -90],
                               intrinsic='auto'),
    VCAMERA_FISHEYE_LEFT=dict(cam_type='FisheyeCamera', resolution=fisheye_resolution, euler_angles=[-135, 0, 0],
                              intrinsic='auto'),
    VCAMERA_FISHEYE_BACK=dict(cam_type='FisheyeCamera', resolution=fisheye_resolution, euler_angles=[-120, 0, 90],
                              intrinsic='auto'),
    VCAMERA_FISHEYE_RIGHT=dict(cam_type='FisheyeCamera', resolution=fisheye_resolution, euler_angles=[-135, 0, 180],
                               intrinsic='auto'),
)
...
train_dataset = dict(
    ...
    name="demo_parking",
    data_root=data_root,
    info_path=f'{data_root}/fb_train_102.pkl',
    model_feeder=dict(
    ...
    group_sampler=dict(type="IndexGroupSampler",
                       ...
                       indices_path=f"{data_root}/train_indice_102_with_ori_mapping_heading_objects.txt"
                       ),
...
val_dataset = dict(
    ...
    info_path=f'{data_root}/planar_lidar_nocamerapose_20230823_110018.pkl',
...
all_bbox_3d_cen_seg_channels = {
    ...
    "bbox_3d_cylinder": 2 + 9 + 1,  # bbox_3d_cylinder
...
parkingslot_3d_weight_scheme = dict(
    ...
    reg=dict(loss_weight=1,
             partition_weights={
                 "dist": {"weight": 10, "slice": (0, 4)},
                 "dir": {"weight": 20, "slice": (4, 10)},
                 "vec": {"weight": 5, "slice": (10, 14)},
...
work_dir = "./work_dirs/planar_lidar_heading"
