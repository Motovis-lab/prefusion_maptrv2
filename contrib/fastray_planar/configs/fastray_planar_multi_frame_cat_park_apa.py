...
val_dataset = dict(
    ...
    data_root='/data/datasets/MV4D_12V3L',
    # info_path='/data/datasets/MV4D_12V3L/mv_4d_infos_20231029_195612.pkl',
    info_path='/data/datasets/MV4D_12V3L/mv_4d_infos_20231028_145730.pkl',
    model_feeder=dict(
        type="FastRayPlanarModelFeeder",
        voxel_feature_config=voxel_feature_config,
        camera_feature_configs=camera_feature_configs,
...
work_dir = "./work_dirs/fastray_planar_multi_frame_cat_park_apa_0106"
# load_from = "./work_dirs/collected_models/apa_bev_occ_epoch_14.pth"
# load_from = "./work_dirs/collected_models/apa_bev_occ_epoch_20.pth"
