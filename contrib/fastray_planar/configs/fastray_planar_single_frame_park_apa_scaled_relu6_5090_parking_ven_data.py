...
train_dataset = dict(
    ...
    name="demo_parking",
    data_root='/mnt/disk1/Motovis_Dataset/mv-4d-annotation-1031/mv4d_local',
    info_path='/mnt/disk1/Motovis_Dataset/mv-4d-annotation-1031/mv4d_local/fb_train_20251031_clean.pkl',
    model_feeder=dict(
    ...
    group_sampler=dict(type="IndexGroupSampler",
                    ...
                    #    indices_path="/mnt/disk1/Motovis_Dataset/mv-4d-annotation-1031/mv4d_local/train_indice_20251023_all_parking_balanced_IPMremove640x2_4dErrorDumped_dis20cm.txt"),
...
work_dir = "./work_dirs/fastray_planar_single_frame_park_apa_1031"
