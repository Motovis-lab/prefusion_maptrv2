...
train_dataset = dict(
    ...
    info_path='/mnt/disk1/Motovis_Dataset/mv-4d-annotation/mv4d_local/fb_train_20251016_clean.pkl',
    model_feeder=dict(
    ...
    group_sampler=dict(type="IndexGroupSampler",
                       ...
                       indices_path="/mnt/disk1/Motovis_Dataset/mv-4d-annotation/mv4d_local/formatted_list.txt"),
...
work_dir = "./work_dirs/fastray_planar_single_frame_park_apa_1017_debug"
# load_from = "./work_dirs/fastray_planar_single_frame_park_apa_0820/20250821_000400/epoch_5.pth"
# load_from = "./work_dirs/pretrained/epoch_15.pth"
