...
mapping_cylinder_objects = dict(
    ...
    class_mapping={
        ...
        "soft_barrier_no_parking": ['class.traffic_facility.soft_barrier::attr.traffic_facility.soft_barrier.type.no_parking'],
...
train_dataset = dict(
    ...
    group_sampler=dict(type="IndexGroupSampler",
                       ...
                       indices_path=f"{data_root}/train_indice_102_with_ori_mapping_oriented_cylinder_objects.txt"   ),
...
work_dir = "./work_dirs/planar_lidar_oriented_cyclinder"
