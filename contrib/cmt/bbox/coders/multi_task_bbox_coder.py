...
from mmengine import MODELS, TASK_UTILS

from contrib.cmt.bbox.util import denormalize_bbox
...
class MultiTaskBBoxCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, task_ids):
        ...
        bbox_preds = bbox_preds[task_index * num_query + bbox_index]  # 这里有个下标越界的，我猜测可能和class num有关，希望问题可以定位到
