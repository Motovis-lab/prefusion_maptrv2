...
class fastray_vt(BaseModule):
    ...
    def forward(self, uu, vv, valid_map_sampled, img_feats, img = None):
            ...
            for i in range(B):
                for k in range(N):
                    ...
                    if img is not None:
                        ...
                        voxel_feature[i][..., valid_map_sampled[i][k]] = img_feats[..., vv_, uu_]
                        import matplotlib.pyplot as plt
                    ...
                    voxel_feature[i][..., valid_map_sampled[i][k]] = img_feats[i][k][..., vv_, uu_]
