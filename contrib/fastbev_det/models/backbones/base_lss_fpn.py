...
class Fish_DepthNet(nn.Module):

    def __init__(self, in_channels, mid_channels, context_channels,
                 depth_channels):
        super(Fish_DepthNet, self).__init__()
...
@MODELS.register_module()
class PV_DepthNet(nn.Module):

    def __init__(self, in_channels, mid_channels, context_channels,
                 depth_channels, tda4=False):
        super(PV_DepthNet, self).__init__()
        self.tda4 = tda4
        self.reduce_conv = nn.Sequential(
            nn.Conv2d(in_channels,
                      mid_channels,
...
class BaseLSSFPN(nn.Module):
    ...
    def get_cam_feats(self, imgs):
        ...
        batch_size, num_cams, num_channels, imH, imW = imgs.shape
        num_sweeps = 1
